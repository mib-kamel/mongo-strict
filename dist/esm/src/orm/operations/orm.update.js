...
export default function update(collection, uniqueKeys, EntityDataValidator, referenceEntities, where, defaultValues, requiredKeys, repositoryOptions) {
    ...
    const setOne = (updateData) => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield checkReferenceEntities(collection, referenceEntities, updateData);
