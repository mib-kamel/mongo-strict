...
exports.getCountAggregateArray = exports.count = exports.getFindAggregateArray = exports.find = void 0;
const orm_interfaces_1 = require("../interfaces/orm.interfaces");
...
function find(Repository, defaultSelectFields = [], findOptions, referenceEntities, repositoryOptions, collectionName) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isFindoptionsCache(findOptions)) {
            ...
            cacheKey = hash((0, telejson_1.stringify)(findClone));
        ...
        (0, utils_1.dataObjectIdToString)(res, referenceEntities);
...
exports.find = find;
function getFindAggregateArray(Repository, defaultSelectFields = [], findOptions, referenceEntities, repositoryOptions, collectionName) {
    var _a, _b, _c;
...
exports.getFindAggregateArray = getFindAggregateArray;
...
function count(Repository, findOptions, referenceEntities, repositoryOptions, collectionName) {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function* () {
        checkAllFindOptionsKeysValid(findOptions);
        const isDebug = findOptions.debug === true || (findOptions.debug !== false && repositoryOptions.debug === true);
...
exports.count = count;
function getCountAggregateArray(findOptions, referenceEntities, repositoryOptions) {
    var _a;
    checkAllFindOptionsKeysValid(findOptions);
    let where = findOptions.where || {};
    where = (0, whereObjectHandle_1.getWhereObject)(where, referenceEntities);
...
exports.getCountAggregateArray = getCountAggregateArray;
const selectItemsToProject = (selectItems) => {
    const selectList = {};
    for (let selectItem of selectItems) {
        if ((0, operationsUtils_1.isId)(selectItem)) {
        ...
        lookupKeys.forEach((currentKey, i) => {
            ...
            if (ref) {
                ...
                if (existingLookup) {
                    ...
                    if (!ref.isArray && (ref.type === orm_interfaces_1.RELATION_TYPES.ONE_TO_ONE || ref.type === orm_interfaces_1.RELATION_TYPES.MANY_TO_ONE)) {
                        curContainer.push({
                            "$unwind": {
                                "path": "$" + as,
                ...
                if (!existingLookup && (ref.type === orm_interfaces_1.RELATION_TYPES.ONE_TO_ONE || ref.type === orm_interfaces_1.RELATION_TYPES.MANY_TO_ONE)) {
    ...
    if (Array.isArray(project)) {
        ...
        for (let key of dataKeys) {
            if (project[key] instanceof Object) {
                ...
                if ((0, operationsUtils_1.isId)(key)) {
