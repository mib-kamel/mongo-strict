...
const MAX_DEPTH = 10;
function initRefsMap(repositoriesMap) {
    repositoriesMap.forEach((value, collectionName) => {
        ...
        for (let i = 0; i < ((_b = (_a = value.entityProperties) === null || _a === void 0 ? void 0 : _a.referenceEntities) === null || _b === void 0 ? void 0 : _b.length) || 0; i++) {
            ...
            if (!ref.type && !ref.isArray) {
                ref.type = orm_interfaces_1.RELATION_TYPES.MANY_TO_ONE;
            }
            if (ref.type === orm_interfaces_1.RELATION_TYPES.MANY_TO_MANY || ref.type === orm_interfaces_1.RELATION_TYPES.ONE_TO_MANY) {
                ref.isArray = true;
            }
    ...
    repositoriesMap.forEach((value, collectionName) => {
        ...
        for (let i = 0; i < (referenceEntites === null || referenceEntites === void 0 ? void 0 : referenceEntites.length) || 0; i++) {
            ...
            let newRelationType = '';
            if (ref.type === orm_interfaces_1.RELATION_TYPES.MANY_TO_ONE) {
                newRelationType = orm_interfaces_1.RELATION_TYPES.ONE_TO_MANY;
            }
            else if (ref.type === orm_interfaces_1.RELATION_TYPES.ONE_TO_MANY) {
                newRelationType = orm_interfaces_1.RELATION_TYPES.MANY_TO_ONE;
            }
            else {
